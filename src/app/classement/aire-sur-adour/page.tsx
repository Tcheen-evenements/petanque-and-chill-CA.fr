...
export default function AireSurAdourRankingPage() {
      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-center text-[#00808b] mb-6">
            Classement de L&apos;Aire sur l&apos;Adour
          </h1>
          <div className="flex justify-center space-x-4">
            ...
            <span className="text-gray-300">|</span>
            <Link href="/classement/aire-sur-adour" className="text-[#00808b] font-bold">
              L&apos;Aire sur l&apos;Adour
            </Link>
            <span className="text-gray-300">|</span>
